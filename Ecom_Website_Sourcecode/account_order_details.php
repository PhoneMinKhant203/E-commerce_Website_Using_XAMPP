...
<body>
    ...
    <div class="account_hero_big">
        ...
        <div class="account-details-container">
            <div class="content-container OD_container">
                <div class="account_Order_detail_Container">
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="back_shopping">
                                <a href="account_order.php"> Back to Order History</a>
                            </div>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4>Payment Method: <?= htmlspecialchars($transaction['payment_type']) ?> Card</h4> <br><br>
                                                ...
                                                <?php foreach ($order_items as $item): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            ?>
                                                            <img src="<?php echo $fullImagePath; ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" style="max-width: 80px;">
                                                        </td>
